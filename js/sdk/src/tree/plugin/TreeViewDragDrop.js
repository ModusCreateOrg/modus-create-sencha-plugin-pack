...
*/
/**
 * @class Ext.tree.plugin.TreeViewDragDrop
 ...
 * <p>Adding this plugin to a view means that two new events may be fired from the client TreeView, <code>{@link #beforedrop beforedrop}</code> and
 * <code>{@link #drop drop}</code></p>
 */

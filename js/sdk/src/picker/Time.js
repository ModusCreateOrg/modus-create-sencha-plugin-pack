...
Ext.define('Ext.picker.Time', {
     ...
     * used); no parsing of String values will be done. Defaults to undefined.
     */
    ...
    /**
     * Update the list of available times in the list to be constrained within the {@link #minValue} and {@link
     * #maxValue}.
     */
    updateList: function() {
        var me = this,

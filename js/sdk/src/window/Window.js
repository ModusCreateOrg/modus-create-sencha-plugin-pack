...
Ext.define('Ext.window.Window', {
     ...
     * pressed, specify this as Ext.emptyFn (See {@link Ext#emptyFn Ext.emptyFn}).
     */

    /**
     * @cfg {Boolean} collapsed
     * True to render the window collapsed, false to render it expanded (defaults to false). Note that if {@link
     * #expandOnShow} is true (the default) it will override the `collapsed` config and the window will always be
     * expanded when shown.
     */
    ...
    */
     ...
     * True to allow the window to be dragged by the header bar, false to disable dragging (defaults to true). Note that
     ...
     * another element specify {@link #renderTo}. (defaults to false). Optionally the header only can be constrained
     ...
     * from the surrounding frame (defaults to false).
     */
    plain: false,
     ...
     * True to always expand the window when it is displayed, false to keep it in its current state (which may be {@link
     ...
     * disallow closing the window (defaults to `true`).
     *
    ...
    /**
     * @cfg {Boolean} hidden
     * Render this Window hidden (default is `true`). If `true`, the {@link #hide} method will be called internally.
     */
    hidden: true,
    ...
    initDraggable: function() {
        ...
        if (me.header) {
             ...
             * If this Window is configured {@link #draggable}, this property will contain an instance of {@link
             * Ext.util.ComponentDragger} (A subclass of {@link Ext.dd.DragTracker DragTracker}) which handles dragging
             * the Window's DOM Element, and constraining according to the {@link #constrain} and {@link
             * #constrainHeader} .
             *

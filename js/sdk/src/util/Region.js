...
Ext.define('Ext.util.Region', {
     ...
     * @param {Ext.util.Point} p (optional) the point
     ...
     * @param {String} axis (optional)
     * @param {Ext.util.Point/Number} p (optional) the point / offset
     * @return {Boolean}
     */
     ...
     * @param {String} axis (optional)
     * @param {Ext.util.Point/Ext.util.Offset/Object} p (optional)
     ...
     * @param {Number} p
     * @param {Number} factor (optional) The factor, defaults to 1
     * @return {Number}
     * @private
     */

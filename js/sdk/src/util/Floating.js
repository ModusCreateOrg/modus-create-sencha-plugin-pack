...
Ext.define('Ext.util.Floating', {
     ...
     * it is {@link #toFront brought to the front}. Defaults to true.
     */
    focusOnToFront: true,
    ...
    doConstrain: function(constrainTo) {
        var me = this,
            vector = me.getConstrainVector(constrainTo||me.el.dom.parentNode),
            xy;
     ...
     *
     * @param {Boolean} preventFocus (optional) Specify `true` to prevent the Component from being focused.
     * @return {Ext.Component} this
     */
    ...
    setActive: function(active, newActive) {
        if (active) {
            if (this.el.shadow && !this.maximized) {

...
Ext.define('Ext.form.field.Field', {
    ...
    /**
     * @cfg {String} name
     * The name of the field (defaults to undefined). By default this is used as the parameter name when including the
     ...
     * True to disable the field (defaults to false). Disabled Fields will not be {@link Ext.form.Basic#submit submitted}.
     */
    disabled : false,
     ...
     * to true. If the validation results in a change in the field's validity, a {@link #validitychange} event will be

...
Ext.define('Ext.form.field.Trigger', {
     ...
     * by default and triggerCls will be **appended** if specified. Defaults to undefined.
     */
     ...
     * action invoked by the trigger. (defaults to true).
     */
    editable: true,
     ...
     * options if the value is true. (defaults to false)
     */
    readOnly: false,
     ...
     * {@link #editable editable} = true (defaults to false).
     */

    /**
     * @cfg {Boolean} repeatTriggerClick
     * true to attach a {@link Ext.util.ClickRepeater click repeater} to the trigger. Defaults to false.
     */

...
Ext.define('Ext.form.field.Checkbox', {
    ...
    /**
     * @cfg {String} focusCls
     * The CSS class to use when the checkbox receives focus (defaults to 'x-form-cb-focus')
     */
     ...
     * An extra CSS class to be applied to the body content element in addition to {@link #fieldBodyCls}. Defaults to
     * 'x-form-cb-wrap'.
     */
     ...
     * determined by the {@link #boxLabelAlign} config (defaults to after).
     */
     ...
     * value when submitting as part of a form. Defaults to "on".
     */
    inputValue: 'on',
     ...
     * @param {Boolean/String} value The following values will check the checkbox: `true, 'true', '1', or 'on'`, as well
     * as a String that matches the {@link #inputValue}. Any other value will uncheck the checkbox.

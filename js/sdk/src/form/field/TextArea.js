...
Ext.define('Ext.form.field.TextArea', {
    ...
    /**
     * @cfg {Number} growMin
     * The minimum height to allow when {@link #grow}=true (defaults to 60)
     */
    growMin: 60,

    /**
     * @cfg {Number} growMax
     * The maximum height to allow when {@link #grow}=true (defaults to 1000)
     */
    growMax: 1000,
     ...
     * @cfg {Number} cols
     * An initial value for the 'cols' attribute on the textarea element. This is only used if the component has no
     * configured {@link #width} and is not given a width by its container's layout. Defaults to 4.
     */
    rows: 4,
     ...
     * relevant when {@link #grow} is true. Equivalent to setting overflow: hidden, defaults to false.
     */

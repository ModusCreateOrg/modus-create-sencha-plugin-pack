...
Ext.define('Ext.form.field.ComboBox', {
     ...
     * by default and `triggerCls` will be **appended** if specified. Defaults to 'x-form-arrow-trigger' for ComboBox.
     */
     ...
     * {@link #delimiter}. (Defaults to `false`.)
     */
    multiSelect: false,
     ...
     * `{@link #multiSelect} = true`. Defaults to `', '`.
     */
    delimiter: ', ',

    /**
     * @cfg {String} displayField
     * The underlying {@link Ext.data.Field#name data field name} to bind to this ComboBox (defaults to 'text').
     *
     ...
     * @required The underlying {@link Ext.data.Field#name data value name} to bind to this ComboBox (defaults to match
     ...
     * `{@link #queryMode}: 'remote'` (defaults to `'query'`). If explicitly set to a falsy value it will not be sent.
     */
    queryParam: 'query',
     ...
     * parameters. Only applies when `{@link #queryMode} = 'remote'` (defaults to `0`).
     */
    pageSize: 0,
     ...
     * opened. (Defaults to `true`). A false value would cause nothing in the list to be highlighted automatically, so

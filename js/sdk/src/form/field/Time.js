...
Ext.define('Ext.form.field.Time', {
     ...
     * valid format -- see {@link #format} and {@link #altFormats} (defaults to undefined).
     */
    ...
    /**
     * @cfg {String} minText
     * The error text to display when the entered time is before {@link #minValue} (defaults to 'The time in this field
    ...
    /**
     * @cfg {String} maxText
     * The error text to display when the entered time is after {@link #maxValue} (defaults to 'The time in this field

...
Ext.define('Ext.form.field.Date', {
     ...
     * according to {@link Ext.Date#parse} (defaults to 'm/d/Y').
     */
    format : "m/d/Y",
    /**
     * @cfg {String} altFormats
     * Multiple date formats separated by "|" to try when parsing a user input value and it does not match the defined
     * format (defaults to 'm/d/Y|n/j/Y|n/j/y|m/j/y|n/d/y|m/j/Y|n/d/Y|m-d-y|m-d-Y|m/d|m-d|md|mdy|mdY|d|Y-m-d|n-j|n/j').
     */
    ...
    /**
     * @cfg {String} minText
     * The error text to display when the date in the cell is before {@link #minValue} (defaults to 'The date in this
     * field must be equal or after {minValue}').
     */
    minText : "The date in this field must be equal to or after {0}",
    /**
     * @cfg {String} maxText
     * The error text to display when the date in the cell is after {@link #maxValue} (defaults to 'The date in this
     * field must be equal or before {maxValue}').
     */
     ...
     * and triggerCls will be **appended** if specified (defaults to 'x-form-date-trigger' which displays a calendar
     * icon).
     */
     ...
     * spacebar that selects the current date (defaults to true).
     */
    showToday : true,
    /**

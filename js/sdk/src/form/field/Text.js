...
Ext.define('Ext.form.field.Text', {
     ...
     * set for this field (defaults to undefined). **Note**: only applies if **`{@link #vtype}`** is set, else ignored.
     */

    /**
     * @cfg {RegExp} stripCharsRe A JavaScript RegExp object used to strip unwanted content from the value
     * before validation (defaults to <tt>undefined</tt>). If <tt>stripCharsRe</tt> is specified, 
     * every character matching <tt>stripCharsRe</tt> will be removed before fed to validation. 
     * This dose not change the value of the field.
     */
    ...
    /**
     * @cfg {Number} growMin
     * The minimum width to allow when `**{@link #grow}** = true` (defaults to 30)
     */
    growMin : 30,

    /**
     * @cfg {Number} growMax
     * The maximum width to allow when `**{@link #grow}** = true` (defaults to 800)
     */
    growMax : 800,
    ...
    /**
     * @cfg {String} vtype
     * A validation type name as defined in {@link Ext.form.field.VTypes} (defaults to undefined)
     */

    /**
     * @cfg {RegExp} maskRe An input mask regular expression that will be used to filter keystrokes (character being
     * typed) that do not match (defaults to <tt>undefined</tt>). 
     * Note: It dose not filter characters already in the input. 
     */

    /**
     * @cfg {Boolean} disableKeyFilter
     ...
     * Error text to display if the **{@link #minLength minimum length}** validation fails (defaults to 'The minimum
     * length for this field is {minLength}')
     */
    minLengthText : 'The minimum length for this field is {0}',

    /**
     * @cfg {String} maxLengthText
     * Error text to display if the **{@link #maxLength maximum length}** validation fails (defaults to 'The maximum
     * length for this field is {maxLength}')
     */
     ...
     * The error text to display if the **{@link #allowBlank}** validation fails (defaults to 'This field is required')
     */
    blankText : 'This field is required',

    /**
     * @cfg {Function} validator
     * A custom validation function to be called during field validation ({@link #getErrors}) (defaults to undefined).
    ...
    /**
     * @cfg {String} emptyCls
     * The CSS class to apply to an empty field to style the **{@link #emptyText}** (defaults to 'x-form-empty-field').

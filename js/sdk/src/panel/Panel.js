...
Ext.define('Ext.panel.Panel', {
     ...
     * Minimum width of all footer toolbar buttons in pixels (defaults to 75). If set, this will be used as the default
     ...
     * the panel's title bar, `false` to render it last (defaults to `true`).
     */
    collapseFirst: true,
     ...
     * the header bar, `false`) to allow it only by clicking to tool button (defaults to `false`)).
     */
    titleCollapse: false,
     ...
     * disallow closing the window (defaults to `false`).
     *
    ...
    /**
     * @cfg {String} title
     * The title text to be used to display in the {@link Ext.panel.Header panel header} (defaults to ''). When a
    ...
    bridgeToolbars: function() {
         ...
         *
         * **NOTE:** The newer way to specify toolbars is to use the dockedItems config, and instead of buttonAlign you

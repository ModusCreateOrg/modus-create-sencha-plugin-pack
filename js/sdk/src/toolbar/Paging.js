...
Ext.define('Ext.toolbar.Paging', {
     ...
     * true to insert any configured items _before_ the paging buttons. Defaults to false.
     */
     ...
     * Customizable piece of the default paging text (defaults to 'of {0}'). Note that this string is formatted using
     ...
     * The quicktip text displayed for the first page button (defaults to 'First Page'). **Note**: quick tips must be
     * initialized for the quicktip to show.
     */
    firstText : 'First Page',

    /**
     * @cfg {String} prevText
     * The quicktip text displayed for the previous page button (defaults to 'Previous Page'). **Note**: quick tips must
     * be initialized for the quicktip to show.
     */
    prevText : 'Previous Page',

    /**
     * @cfg {String} nextText
     * The quicktip text displayed for the next page button (defaults to 'Next Page'). **Note**: quick tips must be
     * initialized for the quicktip to show.
     */
    nextText : 'Next Page',
    ...
    /**
     * @cfg {String} lastText
     * The quicktip text displayed for the last page button (defaults to 'Last Page'). **Note**: quick tips must be
     * initialized for the quicktip to show.
     */
    lastText : 'Last Page',
     ...
     * The quicktip text displayed for the Refresh button (defaults to 'Refresh'). **Note**: quick tips must be
     * initialized for the quicktip to show.
     */
    refreshText : 'Refresh',
